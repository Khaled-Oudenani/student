...
//   return (
//     <nav
//       className="bg-amber-600 text-white border-b-4 border-amber-900 shadow-md z-10"
//       dir="ltr"
//     >
...
//           <Link to="/">
//             <li className="cursor-pointer font-semibold text-2xl hover:text-green-300 transition-colors duration-200">
//               طلبة الدكتورة
//             </li>
//           </Link>
//         </ul>
...
const Navbar = () => {
  ...
  return (
    <nav
      className="bg-blue-500 text-white border-b-4 border-blue-900 shadow-md md:h-12 z-10"
      dir="ltr"
    >
      <div className="flex flex-row justify-between items-center py-2 px-4 md:px-8">
        {/* Logo Section */}
        ...
        <ul className="hidden md:flex flex-row gap-4 justify-center items-center">
          <Link to="/">
            <li className="cursor-pointer font-bold text-2xl hover:text-cyan-300 transition-colors duration-200">
              الصفحة الرئيسية
            </li>
          </Link>
        </ul>

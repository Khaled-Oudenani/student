        ...
        {/* <div className="space-y-3">
          ...
          <div className="border p-3 rounded space-y-2">
            <input
              value={labInput.name}
              onChange={(e) =>
                setLabInput((p) => ({ ...p, name: e.target.value }))
              }
            ...
            <div className="flex items-center gap-3">
              <input
                type="file"
                accept="image/*"
                onChange={handleLabImage}
                className="flex-1"
              />
              {labInput.image && (
                <img src={labInput.image} alt="lab" className="h-16 rounded" />
              )}
            </div>
            <button
              type="button"
        ...
        {/* <div className="space-y-3">
          ...
          <div className="border p-3 rounded space-y-2">
            <input
              ...
              onChange={(e) =>
                setActivityInput((p) => ({ ...p, name: e.target.value }))
              }

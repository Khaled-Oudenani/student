...
//                       className="w-full h-48 object-cover rounded-lg shadow hover:shadow-lg transition-shadow hover:scale-105 duration-300"
//                     />
//                   ))}
//                 </div>
//               </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {student.publicationCertificate && (
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <a
              href={student.publicationCertificate}
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
